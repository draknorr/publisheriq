-- =============================================================================
-- Migration: Fix Playtime Column References in Apps RPC
--
-- Problem:
--   get_apps_with_filters and get_apps_aggregate_stats reference
--   ldm.average_playtime_forever and ldm.average_playtime_2weeks from
--   latest_daily_metrics, but these columns only exist in daily_metrics.
--
-- Fix:
--   Add LATERAL join to fetch playtime from daily_metrics table.
-- =============================================================================

-- ============================================================================
-- Replace get_apps_with_filters with playtime fix
-- ============================================================================
...
COMMENT ON FUNCTION get_apps_with_filters IS
  'Optimized Games page query using app_filter_data materialized view. Uses LATERAL join to daily_metrics for playtime data. Expected query time: 50-200ms.';


-- ============================================================================
-- Update get_apps_aggregate_stats with playtime fix
-- ============================================================================
...
COMMENT ON FUNCTION get_apps_aggregate_stats IS
  'Optimized aggregate stats using app_filter_data materialized view. Uses LATERAL join for playtime data.';
