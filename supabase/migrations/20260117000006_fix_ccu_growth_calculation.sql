-- =============================================================================
-- Migration: Fix CCU Growth Calculation Window
-- Purpose: Use 3-day comparison windows instead of 7-day to work with limited
--          snapshot history (~7 days available instead of required 14 days)
-- =============================================================================

-- Update column comments to reflect the new calculation window
...
-- Changed: Uses 3-day windows instead of 7-day for growth calculation
--          This requires only 6 days of data instead of 14 days
-- =============================================================================
...
BEGIN
  ...
  -- CHANGED: Using 3-day windows instead of 7-day to work with limited snapshot history
...
COMMENT ON FUNCTION recalculate_ccu_tiers() IS 'Recalculates tier assignments and CCU growth percentages. Tier 1 = top 500 by 7-day peak CCU, Tier 2 = 1000 newest releases not in Tier 1, Tier 3 = all others. Growth calculated using 3-day comparison windows from ccu_snapshots.';
