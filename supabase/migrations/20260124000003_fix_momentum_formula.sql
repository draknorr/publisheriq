-- =============================================================================
-- Migration: Fix Momentum Formula
--
-- Problem:
--   Momentum formula mixes percentage (CCU growth %) with absolute value
--   (velocity_7d - velocity_30d in reviews/day). High-traffic games get extreme
--   momentum values because absolute velocity dominates.
--
-- Fix:
--   Normalize velocity_acceleration to percentage change:
--   velocity_pct_change = ((velocity_7d - velocity_30d) / velocity_30d) * 100
--   momentum = (ccu_growth_7d_percent + velocity_pct_change) / 2
--
-- Before (ARC Raiders example):
--   CCU Growth: -22.30%, Velocity Delta: -104.32 reviews/day, Momentum: -63.31
--
-- After:
--   CCU Growth: -22.30%, Velocity Change: -11.94%, Momentum: -17.12
-- =============================================================================

-- ============================================================================
-- Replace get_apps_with_filters with fixed momentum formula
-- ============================================================================
...
COMMENT ON FUNCTION get_apps_with_filters IS
  'Optimized Games page query. Momentum formula fixed: now uses percentage-based velocity change for comparability across all games. Expected query time: 50-200ms.';


-- ============================================================================
-- Update get_apps_aggregate_stats with fixed momentum formula
-- ============================================================================
...
COMMENT ON FUNCTION get_apps_aggregate_stats IS
  'Aggregate stats with fixed momentum formula using percentage-based velocity change.';
