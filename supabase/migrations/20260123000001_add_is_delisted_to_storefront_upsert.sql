-- Migration: Add is_delisted parameter to upsert_storefront_app
--
-- Tracks whether a game can be purchased on Steam (packages exists)
-- is_delisted = true when packages is null/empty
...
COMMENT ON FUNCTION upsert_storefront_app(INTEGER, TEXT, TEXT, BOOLEAN, BOOLEAN, DATE, TEXT, BOOLEAN, INTEGER, INTEGER, BOOLEAN, TEXT[], TEXT[], INTEGER[], INTEGER) IS
  'Single-call upsert with is_delisted tracking for games without purchasable packages';
