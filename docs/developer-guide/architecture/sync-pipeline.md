...
**Environment Variables**: `INTERPOLATION_DAYS` (default 30), `INTERPOLATION_APP_BATCH_SIZE` (default 2000)
...
| `apps` columns     | controller*support, platforms, pics_review*\*, metacritic_score |
