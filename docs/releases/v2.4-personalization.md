...
- [User Guide](../guides/personalization.md) - How to use the personalization feature
- [Smart Query Suggestions](../features/smart-query-suggestions.md) - Type-ahead autocomplete and chips
- [Chat Interface Guide](../guides/chat-interface.md) - Using concept search and trending discovery
- [Architecture](../architecture/personalized-dashboard.md) - Personalization technical details
- [Chat Data System](../architecture/chat-data-system.md) - Full chat/Cube.js reference
