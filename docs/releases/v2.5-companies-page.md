...
|--------|-------------|----------|
| Major 10+ | Large catalogs | ≥10 games |
| Prolific 5+ | Established studios | ≥5 games |
| Active | Recent releases | Released in last 12 months |
| Trending | Growing CCU | Any positive growth |
| $1M+ | Revenue threshold | ≥$1M estimated revenue |
| $10M+ | High revenue | ≥$10M estimated revenue |
| 100K+ | Large audience | ≥100K total owners |
...
| Reviews/1K Owners | (Reviews ÷ Owners) × 1000 | Audience engagement rate |
...
70×24px CCU trend visualizations:
...
| Pre-computed content arrays | Tag filtering: 7.7s → <200ms |
...
- [Companies Page User Guide](../guides/companies-page.md) - How to use the Companies page
- [Companies Page Architecture](../architecture/companies-page.md) - Technical implementation details
- [Publishers & Developers Pages (Legacy)](../architecture/publishers-developers-pages.md) - Previous implementation
