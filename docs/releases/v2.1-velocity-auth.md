...
- [Database Schema](../developer-guide/architecture/database-schema.md) - Updated with new tables
- [Chat Data System](../developer-guide/architecture/chat-data-system.md) - New tools and cubes
- [Sync Pipeline](../developer-guide/architecture/sync-pipeline.md) - Velocity scheduling details
- [Running Workers](../developer-guide/workers/running-workers.md) - New worker commands
- [Troubleshooting](../admin-guide/troubleshooting.md) - Auth and velocity issues
