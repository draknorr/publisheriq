...
/**
 * Command Palette Genres View
 *
 * Browse and select all Steam genres.
 * Simpler than tags view - flat list with search.
 */
            ...
            <div>
              ...
              <p className="text-caption text-text-muted">
                {selectedGenres.length > 0
                  ...
                  : 'Select genres to filter results'}
              </p>
            </div>
          </div>
