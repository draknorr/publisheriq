...
function PICSStatusCard({
  ...
  const dataFields = [
    ...
    { label: 'Categories', count: picsDataStats.withCategories, icon: '📁', color: 'text-purple-400', isTotal: true },
    { label: 'Genres', count: picsDataStats.withGenres, icon: '🎯', color: 'text-orange-400', isTotal: true },
    { label: 'Franchises', count: picsDataStats.withFranchises, icon: '🏢', color: 'text-cyan-400', isTotal: true },
    { label: 'Parent App', count: picsDataStats.withParentApp, icon: '🔗', color: 'text-yellow-400', isTotal: true },
  ];
