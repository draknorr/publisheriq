...
import { Calendar, Wrench, CheckCircle2, XCircle, AlertTriangle, Clock } from 'lucide-react';
...
export function AppDetailTabs({
  ...
  // appid available for future use (e.g., actions, API calls)
  void _appid;
  ...
  return (
    <div>
      ...
      {currentTab === 'reviews' && (
        <ReviewsTab histogram={histogram} />
      )}

      {currentTab === 'sync' && (
        <SyncTab syncStatus={syncStatus} />
      )}
    </div>
  );
}
...
function MetricsTab({
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {chartData.length > 0 ? (
        <>
          <Section title="Total Reviews Over Time">
            <Card padding="lg">
              <AreaChartComponent
                data={chartData}
                xKey="date"
          ...
          <Section title="Peak CCU Over Time">
            <Card padding="lg">
              <AreaChartComponent
                data={chartData}
                xKey="date"
          ...
          <Section title="Daily Metrics History">
            <Card padding="none">
...
function ReviewsTab({
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {histogram.length > 0 ? (
        <>
          <Section title="Monthly Review Distribution">
            <Card padding="lg">
              <StackedBarChart
                data={histogramData}
                xKey="month"
                ...
                <table className="w-full min-w-[600px]">
                  <thead className="bg-surface-elevated">
                    <tr>
                      ...
                      <th className="px-4 py-3 w-40 text-caption font-medium text-text-secondary">Distribution</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-border-subtle">
